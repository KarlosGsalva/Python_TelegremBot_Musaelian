...
text_bot_show_meetings_details = (
    "Для просмотра календаря в браузере, нажмите на кнопку\n "
...
async def test_cmd_10_show_user_calendar(dp, bot):
    ...
    cmd_10_result = await dp.feed_update(
        bot, Update(message=user_message_cmd_10, update_id=10)
    )
